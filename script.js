...
const data = [
    ...
    {id: 3,
        title: "Recreational",
        graf: `If you’ve never used cannabis, before walking into a dispensary to buy, you’ll have some important things to consider, most importantly your personal health and safety.</p>
        <p class = 'graf'>Thankfully, one of legalization’s major benefits is the greater sense of certainty it provides to consumers that they’re getting exactly what is on the label.</p>
        <blockquote><span class = "quote">'Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, resquietat in pace en nomine file et spiritu sancti.'</span><br><span class = "source">- Wayne Gretzky</span></blockquote>
    ...
    {id: 4,
        ...
        <p class = 'graf'>Licensed growers will be able to operate between 10,000 and 300,000 square feet of indoor grow space, enough to produce an estimated over half a million pounds of cannabis per year.</p>
        <p class = 'graf'>Like dispensaries, prospective growers who want to deal in smaller amounts have the option to apply for a “micro-license” which will grant them the opportunity to grow any amount under 10,000 square feet.`, 
        newButtons: [7], 
    ...
    {id: 5,
        ...
        <p class = 'graf'>Licensed processors will be allowed to process anywhere above 1,000 pounds of cannabis per year under the new law. Like with other types of licenses there will be \“micro-licenses\” that allow licensees to process up to 1,000 pounds yearly.</p>`,
        newButtons: [7],
        nextQuestion: "What now?",
    ...
    {id: 6,
        ...
        <p class = 'graf'>The bill also provides an option for prospective sellers who don’t necessarily want to operate a store. “Micro-licenses” will allow businesses to operate a delivery service for cannabis products as long as that business has fewer than 10 employees.`,
        newButtons: [7],
        nextQuestion: "What now?"
    },
    {id: 7,
        title: "Get Licensed",
        graf: `You’ve done all your homework. You’ve got your finances in order. You’ve studied the viability of the idea. You put a business plan together. You have investors lined up. The final step before you can become a bonafide cannabis entrepreneur is a seal of approval from the state in the form of a license to operate.</p>
        <p class = 'graf'>Competition for licenses is expected to be fierce given high demand for cannabis. That said, the state still needs operators who will be ready to meet the state’s demand on day one. To that aim, current licensed medical operators will have the opportunity to convert their license to a recreational one by paying a conversion fee in line with their revenue. Though some medical operators feel this amount is too high.</p>
        ...
        <p class = 'graf'>The bill defines a “disproportionately impacted area” as a means a geographic area outlined by the state cannabis commission’s new office of social equity that had above 150% of the state’s 10-year average for cannabis possession charges. Licenses for second-round applicants will begin to be issued by May of 2024.</p>
        <p class = 'graf'>Applying for a license will also come at a cost. A standard license application will cost prospective licensees $5,000 while an application for a “micro-license” will run $1,000. `,
        newButtons: [],
        nextQuestion: "",
